package com.shin.shaman_king.entities.renderer;
...
@OnlyIn(Dist.CLIENT)
public class MorphinTest extends EntityRenderer<MorphinProjectile> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/entity/fishing_hook.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutout(TEXTURE_LOCATION);
    private static final double VIEW_BOBBING_SCALE = 960.0D;

    public MorphinTest(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
     ...
     */
    public ResourceLocation getTextureLocation(MorphinProjectile pEntity) {
